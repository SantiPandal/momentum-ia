...
config1 = {'configurable': {'thread_id': 'new_user_test'}}
agent_input1 = {'messages': [HumanMessage(content='Hi, I am new here!')]}
...
config2 = {'configurable': {'thread_id': 'another_user'}}
agent_input2 = {'messages': [HumanMessage(content='I want to lose 10 pounds in 2 months')]}
